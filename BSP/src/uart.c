...
void Free_Uart2(void)
{
  ...
  memset(Uart2.S_Buffer,0,UART2_SBUF_NUM);                               //清空串口2发送长度
  memset(Uart2.R_Buffer,0,UART2_RBUF_NUM);
...
{
  Uart3.Send_Length = 0;                                //清空串口2发送长度
  Uart3.Sent_Length = 0;                             //清空串口2接收长度
  Uart3.Send_Busy = FALSE;                              //清空串口2发送忙标志  
  Uart3.Receive_Busy = FALSE;                           //清空串口2接收忙
  Uart3.Receive_Pend = FALSE;                           //清空串口2挂起
}
/*********************************************************************************
 Function:      //
 Description:   //
